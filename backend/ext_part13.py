...
PART = {
    ...
    "T1583.001": r("nslookup localhost & echo AF acquire-domains proxy", "Loopback DNS as an acquire-domains proxy."),
    "T1583.002": r("nslookup -type=NS localhost", "Loopback NS lookup as an acquire-DNS-server proxy."),
    ...
    "T1583.006": r("nslookup localhost & echo AF acquire-web-services proxy", "Loopback DNS as an acquire-web-services proxy."),
    ...
    "T1584.001": r("nslookup localhost", "Loopback DNS as a compromise-domains proxy."),
    "T1584.002": r("nslookup -type=NS localhost", "Loopback NS lookup as a compromise-DNS-server proxy."),
