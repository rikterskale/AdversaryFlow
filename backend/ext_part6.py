...
PART = {
    ...
    "T1036.010": [c("windows", "net user AdversaryFlowAdmin * /add & echo AF masquerade-account-name proxy (requires admin; enter a unique temporary password)",
                    "Creates a lab look-alike account and prompts for a unique password.", "net user AdversaryFlowAdmin /delete")],
