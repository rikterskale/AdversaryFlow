...
Only the latest minor release receives routine fixes until a 1.0 support window is published. Upgrade instructions and breaking changes are documented in `CHANGELOG.md`.
