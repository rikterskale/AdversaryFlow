...
def _campaign_detail(campaign_root: str, campaign_id: str, roe_path: str, catalog_path: str) -> dict[str, object]:
    ...
    campaign["detail"] = {
        ...
        "approval_readiness": _approval_readiness(status, draft, roe, selected, integrity),
    }
    return campaign
