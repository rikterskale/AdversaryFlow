...
def complete_saved_campaign(campaign_root: str, campaign_id: str, roe: RulesOfEngagement, abilities: tuple[Ability, ...], approver: str, output_root: str, adapter_name: str = "local-synthetic") -> dict[str, object]:
    ...
    run_dir = run_local_emulation(draft, abilities, approval, output_root, adapter_name)
    ...
    metadata.update({"status": "completed", "run_dir": str(run_dir), "adapter": adapter_name})
