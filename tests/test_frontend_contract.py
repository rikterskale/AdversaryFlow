...
class FrontendContractTests(unittest.TestCase):
    ...
    def test_confirmations_and_resume_are_in_app_controls(self):
        ...
        self.assertNotIn('id="recommendedBtn"', self.html)
        self.assertNotIn("startRecommended", self.javascript)
        self.assertNotIn("FEATURED", self.javascript)
        self.assertIn('id="helpDialog"', self.html)
        self.assertIn('id="setupError"', self.html)
        self.assertIn('id="retryLoad"', self.html)
        self.assertIn('id="firstLabHint"', self.html)
        self.assertIn("bounded synthetic", self.javascript)
        self.assertIn("lab proxy", self.javascript)
        self.assertIn("firstLabCommand", self.javascript)
        self.assertIn("defaultCommandPlatform", self.javascript)
        self.assertIn("Try this first", self.javascript)
