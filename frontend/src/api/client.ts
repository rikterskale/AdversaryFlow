import { isRecord, parseActors, parseBootstrap, parseHealth, parseSession } from "./guards";
import type { ActorsResponse, AttackDomain, BootstrapResponse, HealthResponse, SessionResponse } from "./contract";
